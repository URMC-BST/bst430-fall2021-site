...
.footnote[[1] Must escape with backticks,e.g,  `\` Number of bathrooms \``]
---
class: code70
...
-  We'll touch on this again, later when we pull off the training wheels and make and manage our own Rstudio projects using the desktop version of Rstudio
-  Picking a sensible and consistent way to organize raw and processed data will save many headaches!
-  Hint: generally data should live in its own folder in the analysis project, but sometimes the loading and tidying of the data might be its own project, per se...
-  And sometimes data is too big or too sensitive to put on github.
-  Use of Rstudio cloud, here, does limit potential solutions.  Note it is possible to upload and download files to and from your desktop using the "files" pane.
