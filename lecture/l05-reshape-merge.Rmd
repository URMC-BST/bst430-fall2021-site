...
1.  A bit more dplyr
2.  Reshaping a single data frame
3.  Joining multiple data frames
...
library(tidyverse)
library(knitr)
customers = read_csv("l05-WIP/data/sales/customers.csv")
prices = read_csv("l05-WIP/data/sales/prices.csv")
```
...
include_graphics("l05-WIP/img/tidyr-part-of-tidyverse.png")
```
]
.pull-right[
...
include_graphics("l05-WIP/img/pivot.gif")
```
...
include_graphics("l05-WIP/img/tidyr-longer-wider.gif")
```
]
...
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("l05-WIP/img/biden-approval.png")
```
...
```{r include=FALSE}
biden = read_csv("l05-WIP/data/trump/biden.csv")
```
...
```{r include=FALSE}
professions = read_csv("l05-WIP/data/scientists/professions.csv")
dates = read_csv("l05-WIP/data/scientists/dates.csv")
works = read_csv("l05-WIP/data/scientists/works.csv")
```
...
include_graphics("l05-WIP/img/left-join.gif")
```
]
.pull-right[
```{r}
...
.pull-left[
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("l05-WIP/img/right-join.gif")
```
]
.pull-right[
```{r}
...
.pull-left[
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("l05-WIP/img/full-join.gif")
```
]
.pull-right[
```{r}
...
.pull-left[
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("l05-WIP/img/inner-join.gif")
```
]
.pull-right[
```{r}
...
.pull-left[
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("l05-WIP/img/semi-join.gif")
```
]
.pull-right[
```{r}
...
.pull-left[
```{r echo=FALSE, out.width="80%", out.extra ='style="background-color: #FDF6E3"'}
include_graphics("l05-WIP/img/anti-join.gif")
```
]
.pull-right[
```{r}
...
```{r include=FALSE}
enrolment = read_csv("l05-WIP/data/students/enrolment.csv")
survey = read_csv("l05-WIP/data/students/survey.csv")
```
...
```{r include=FALSE}
purchases = read_csv("l05-WIP/data/sales/purchases.csv")
prices = read_csv("l05-WIP/data/sales/prices.csv")
```
