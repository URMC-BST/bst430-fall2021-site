...
.footnote[But there are also `NA_integer_`, `NA_real_` and `NA_character_`, which will be used in a vector of those types.]
---
...
*  vectors must be flat and "atomic"--comprised of only a single base R type: `logical`, `integer`, `numeric` or `character`.
...
Classes are an `attribute` that signify a compound type (made of multiple elements or compounds).
