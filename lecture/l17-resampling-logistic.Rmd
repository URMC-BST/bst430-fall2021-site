...
- Whereby the glm allows non-linear effects in $\beta$, and non-constant residual variance.
...
-  In the typical case, we use cross-validation to tune and select between models, then use the train/test split to evaluate the final choosen model
