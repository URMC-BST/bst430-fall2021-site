...
1. If there are 5 faculty types and 11 years of data, how many rows will the pivotted data have?  Do the pivot and save the data into an object `staff_long`.
