...
In this assignment we explore  the [2016 GSS dataset](https://rstudio-education.github.io/dsbox/reference/gss16.html).
...
## Part ii: Harassment at work (bootstrapping)
...
14. Calculate a 95% bootstrap confidence interval for the proportion of Americans who have been harassed by their superiors or co-workers at their job. Interpret the statistical properties of this interval, and in the context of the data.

## Part iii: (many linear models)

15.  Using `gapminder`, fit a linear model over all countries on `log(pop)` vs (years-1990), so that the intercept reflects the log-population in 1990.  Interpet the slope and intercept in terms of the unlogged variables.
...
16.  Now, completing the code below, fit this model per country.  In a table, report the top 3 and bottom 3 countries in terms of the population growth rates, and their 95\% confidence intervals.
