...
1.  Consider Alabama, Arizona, California, Florida, New York and Texas from **2020-03-01** onward.  Make a line plot akin to the one below of daily cases and deaths in each county in these states.  Facet by state.  (Your plot does not need to be identical, merely needs to convey the same information.)
