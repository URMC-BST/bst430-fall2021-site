...
Go to the course GitHub organization and locate your homework repo, clone it in RStudio **in the BST430fall2021 workspace** and open the R Markdown document.
...
-   Update the YAML, changing the author name to your name, and **knit** the document. `r emo::ji('knit')`
-   Commit your changes with a meaningful commit message. `r emo::ji('check')`
-   Push your changes to GitHub. `r emo::ji('up arrow')`
...
11. Filter the data for observations in New Jersey only, and recreate the plot.
