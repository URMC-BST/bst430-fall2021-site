...
library(tidyverse)
nycbnb = read_csv('data/nylistings.csv')
```
...
8.  [**extracredit**] Come up with a proposal using other variables present in the data set to ameliorate one or more of the weaknesses identified in 7, and implement it.
