...
*  Go to the URMC-BST GitHub organization and locate your homework repo, which should be named `hw-01-airbnb-nyc-YOUR_GITHUB_USERNAME`. Grab the URL of the repo, and clone it in RStudio.
